...
class BwBInstall {
  ...
  public static function bwb_config(Event $event) {
    ...
    $bwb_config_params = array(
      ...
      ':site_domain'        => $params['bwb_wp_config']['site_domain'],
      ...
      ':core_dir'           => $params['bwb_wp_config']['core_dir'],
      ':plugin_dir'         => $params['bwb_wp_config']['plugin_dir'],
      ':content_dir'        => $params['bwb_wp_config']['content_dir'],
      ':upload_dir'         => $params['bwb_wp_config']['upload_dir'],
      ':multisite'          => $params['bwb_wp_config']['multisite'],
      ':multisite_text'     => '',
      ':subdomains'         => (false !== $params['bwb_wp_config']['subdomains']) ? 'true' : 'false'
    ...
    if ( $params['bwb_wp_config']['multisite'] ) :
      $bwb_config_params[':subdomains'] = (false !== $params['bwb_wp_config']['subdomains']) ? 'true' : 'false';
      $bwb_config_params[':multisite_text'] = "define('MULTISITE', true);\n";
      $bwb_config_params[':multisite_text'] .= "define('SUBDOMAIN_INSTALL', $bwb_config_params[':subdomains']);\n";
      $bwb_config_params[':multisite_text'] .= "define('DOMAIN_CURRENT_SITE', $bwb_config_params[':site_domain']);\n";
      $bwb_config_params[':multisite_text'] .= "define('DOMAIN_CURRENT_SITE', $bwb_config_params[':site_domain']);\n";
      $bwb_config_params[':multisite_text'] .= "define('PATH_CURRENT_SITE', '/');\n";
      $bwb_config_params[':multisite_text'] .= "define('SITE_ID_CURRENT_SITE', 1);\n";
      $bwb_config_params[':multisite_text'] .= "define('BLOG_ID_CURRENT_SITE', 1);\n";
    endif;
    
    $bwb_config_params[':sunrise'] = 'off'; 

    if ( $params['bwb_wp_config']['multidomain'] ) :
      $bwb_config_params[':sunrise'] = 'on';
      //copy sunrise.php file from plugin here?
      //or use wp-cli to install the plugin at this point if requested?
    endif;
